...
@Database(entities = [SavingsEntity::class, WishesEntity::class], version = 3, exportSchema = true,autoMigrations = [AutoMigration(from = 1, to = 2/*,spec = MyAutoMigration::class*/),AutoMigration(from = 2, to = 3)])
